...
internal class StringWithCursorTest {
    @Test fun advance() {
        ...
        assertFailsWith(IndexOutOfBoundsException::class) { x.advance() }
    }
    ...
    @Test fun advanceBy() {
        ...
        assertEquals(6, x.cursorPos)
        assertFailsWith(IndexOutOfBoundsException::class) { x.advanceBy(-1) }
    ...
    @Test fun retreatBy() {
        ...
        assertFailsWith(IndexOutOfBoundsException::class) { x.retreatBy(-1) }
    }
