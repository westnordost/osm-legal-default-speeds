...
class BooleanExpressionBuilderTest {
    ...
    @Test fun closed_too_many_brackets_1() {
        assertFailsWith(IllegalStateException::class) {
            TestBooleanExpressionParser.parse("a+b)")
        }
    }

    @Test fun closed_too_many_brackets_2() {
        assertFailsWith(IllegalStateException::class) {
            TestBooleanExpressionParser.parse("(a+b))")
        }
    }

    @Test fun closed_too_many_brackets_3() {
        assertFailsWith(IllegalStateException::class) {
            TestBooleanExpressionParser.parse("((b+c)*a)+d)")
        }
    }

    @Test fun closed_too_few_brackets_1() {
        assertFailsWith(IllegalStateException::class) {
            TestBooleanExpressionParser.parse("(a+b")
        }
    }

    @Test fun closed_too_few_brackets_2() {
        assertFailsWith(IllegalStateException::class) {
            TestBooleanExpressionParser.parse("((a+b)")
        }
    }

    @Test fun closed_too_few_brackets_3() {
        assertFailsWith(IllegalStateException::class) {
